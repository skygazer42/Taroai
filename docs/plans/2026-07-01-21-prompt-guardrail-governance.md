...
- Agent Runtime artifact publication enforcement is started: guarded artifact metadata can be blocked, redacted, or paused for persisted approval before artifact creation, and audit metadata records summary fields without raw artifact names or URIs.
